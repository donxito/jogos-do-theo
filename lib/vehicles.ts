...
export const vehicles: Vehicle[] = [
  ...
  { id: "truck", emoji: "🚚", sound: "Brrrum!", pt: "Camião", da: "Lastbil", bg: "#FFE8CC", color: "#D35400", accent: "#E67E22" },
  { id: "train", emoji: "🚂", sound: "Chu chu!", pt: "Comboio", da: "Tog", bg: "#E8DAEF", color: "#7D3C98", accent: "#9B59B6" },
  ...
  { id: "motorcycle", emoji: "🏍️", sound: "Vraaau!", pt: "Mota", da: "Motorcykel", bg: "#FDEBD0", color: "#B9770E", accent: "#F39C12" },
